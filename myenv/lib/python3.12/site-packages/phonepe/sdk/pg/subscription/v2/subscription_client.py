...
class SubscriptionClient(BaseClient):
    ...
    def get_instance(
        ...
        """
        should_publish_events = should_publish_events and env == Env.PRODUCTION
        if SubscriptionClient.instance is None:
            SubscriptionClient.instance = SubscriptionClient(
                client_id=client_id,
            ...
            SubscriptionClient.instance.event_publisher.send(init_event)
        ...
        cached_client_sha = calculate_hash(
            str(SubscriptionClient.instance.credential_config.client_id),
            str(SubscriptionClient.instance.credential_config.client_version),
            str(SubscriptionClient.instance.credential_config.client_secret),
            str(SubscriptionClient.instance.env),
            str(SubscriptionClient.instance.should_publish_events),
            str(FlowType.SUBSCRIPTION),
        )
        ...
        raise PhonePeException(
            message="Cannot re-initialize SubscriptionClient. Please utilize the existing Client object with "
