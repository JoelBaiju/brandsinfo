...
class CustomCheckoutClient(BaseClient):
    ...
    def get_instance(
        ...
        """
        should_publish_events = should_publish_events and env == Env.PRODUCTION
        if CustomCheckoutClient.instance is None:
            CustomCheckoutClient.instance = CustomCheckoutClient(
                client_id=client_id,
            ...
            CustomCheckoutClient.instance.event_publisher.send(init_event)
            return CustomCheckoutClient.instance
        ...
        cached_client_sha = calculate_hash(
            str(CustomCheckoutClient.instance.credential_config.client_id),
            str(CustomCheckoutClient.instance.credential_config.client_version),
            str(CustomCheckoutClient.instance.credential_config.client_secret),
            str(CustomCheckoutClient.instance.env),
            str(CustomCheckoutClient.instance.should_publish_events),
            str(FlowType.PG),
        )
        ...
        raise PhonePeException(
            message="Cannot re-initialize CustomCheckoutClient. Please utilize the existing Client object with "
